...
class World(object):
    ...
    def __init__(self, players, shuffle, doorShuffle, logic, mode, swords, difficulty, difficulty_adjustments, timer, progressive, goal, algorithm, accessibility, shuffle_ganon, retro, custom, customitemarray, hints):
        ...
        self.teams = 1
        self.shuffle = copy.copy(shuffle)
        self.doorShuffle = copy.copy(doorShuffle)
        self.logic = copy.copy(logic)
        self.mode = copy.copy(mode)
        self.swords = copy.copy(swords)
        self.difficulty = copy.copy(difficulty)
        self.difficulty_adjustments = copy.copy(difficulty_adjustments)
        self.timer = timer
        ...
        self.accessibility = copy.copy(accessibility)
        self.fix_skullwoods_exit = {}
        self.fix_palaceofdarkness_exit = {}
        self.fix_trock_exit = {}
        self.shuffle_ganon = shuffle_ganon
        self.fix_gtower_exit = self.shuffle_ganon
        self.retro = copy.copy(retro)
        self.custom = custom
