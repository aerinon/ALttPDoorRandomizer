...
class TextTable(object):
    ...
    def setDefaultText(self):
        ...
        text['limited_run_message_0'] = CompressedTextMapper.convert("{NOTEXT}", False)
        text['limited_run_message_1'] = CompressedTextMapper.convert("{NOTEXT}", False)
        text['limited_run_message_2'] = CompressedTextMapper.convert("{NOTEXT}", False)
        text['limited_run_message_3'] = CompressedTextMapper.convert("{NOTEXT}", False)
        text['limited_run_message_4'] = CompressedTextMapper.convert("{NOTEXT}", False)
