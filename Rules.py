...
def global_rules(world, player):
    ...
    set_rule(world.get_entrance('Mire Fishbone Blue Barrier Bypass', player), lambda state: False) # state.can_use_bombs(player) // Is very easy to do, but should it be in logic?
