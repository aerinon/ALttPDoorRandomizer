...
def create_dungeon_regions(world, player):
    ...
    world.regions += [
        ...
        create_dungeon_region(player, 'PoD Arena Main', 'Palace of Darkness', None, ['PoD Arena Main SW', 'PoD Arena Main to Ranged Crystal', 'PoD Arena Main to Landing Barrier - Blue', 'PoD Arena Main to Landing Bypass', 'PoD Arena Main to Right Bypass', 'PoD Arena Main to North Bypass']),
        ...
        create_dungeon_region(player, 'Thieves Triple Bypass West', 'Thieves\' Town', None, ['Thieves Triple Bypass WN', 'Thieves Triple Bypass West to North', 'Thieves Triple Bypass West to South']),
        create_dungeon_region(player, 'Thieves Triple Bypass East', 'Thieves\' Town', None, ['Thieves Triple Bypass EN', 'Thieves Triple Bypass East to North', 'Thieves Triple Bypass East to South']),
        create_dungeon_region(player, 'Thieves Triple Bypass South', 'Thieves\' Town', None, ['Thieves Triple Bypass SE', 'Thieves Triple Bypass South to West', 'Thieves Triple Bypass South to East']),
        create_dungeon_region(player, 'Thieves Triple Bypass North', 'Thieves\' Town', None, ['Thieves Triple Bypass North to West', 'Thieves Triple Bypass North to East']),
