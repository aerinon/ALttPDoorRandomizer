...
vanilla_sheets = [
    ...
    (0x1F, 0x1E, 0x30, 0x52), (0x51, 0x49, 0x13, 0x50), (0x4F, 0x49, 0x13, 0x50), (0x4F, 0x4D, 0x4A, 0x52), # edits for limited run
...
def setup_required_dungeon_groups(sheets, data_tables):
    ...
    free_sheet_reqs = [
        ...
        ([None, None, None, (82, 83)], [0x13, 0x23, 0x96, 0xa5, 0xc5, 0xd5, 0x101]),
