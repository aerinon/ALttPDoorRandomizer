...
thieves_regions = [
    ...
    'Thieves Hellway N Crystal', 'Thieves Hellway S Crystal', 'Thieves Triple Bypass North',
    'Thieves Triple Bypass South', 'Thieves Triple Bypass East', 'Thieves Triple Bypass West', 'Thieves Spike Switch',
